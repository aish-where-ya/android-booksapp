    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            finish();*/
             ...
             finish();
            Intent toy = new Intent(MainActivity.this,SellBooks.class);
            startActivity(toy);
            ...
            finish();
            Intent toy = new Intent(MainActivity.this,YourProducts.class);
            startActivity(toy);
        ...
        else if(id== R.id.edit_profile)
        {
            ...
            finish();
            Intent toy = new Intent(MainActivity.this,EditProfile.class);
            startActivity(toy);
        }
        else if( id == R.id.delete_profile)
        {
            ...
            finish();
            Intent toy = new Intent(MainActivity.this,FirstPage.class);
            startActivity(toy);
        }
